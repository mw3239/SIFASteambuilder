...
add.accessory(3,1,3,5,20)
add.accessory(1,1,3,5,1)
add.accessory(1,2,3,0,1)
add.accessory(3,5,3,0,1)
add.accessory(5,1,3,0,1)
add.accessory(5,1,3,0,1)
add.accessory(6,2,3,0,1)
add.accessory(6,3,3,0,1)
add.accessory(7,1,3,1,1)
add.accessory(7,5,3,1,1)
add.accessory(7,2,3,0,1)
add.accessory(2,4,2,1,1)
add.accessory(2,5,2,1,1)
add.accessory(2,6,2,0,1)
add.accessory(3,3,2,4,1)
add.accessory(3,5,2,2,1)
add.accessory(4,2,2,2,1)
add.accessory(4,4,2,1,1)
add.accessory(4,6,2,2,1)
add.accessory(5,4,2,3,1)
add.accessory(5,6,2,3,1)
add.accessory(6,2,2,2,1)
add.accessory(6,3,2,3,1)
add.accessory(7,1,2,0,1)
add.accessory(7,2,2,1,1)
add.accessory(7,5,2,2,1)
add.accessory(8,6,2,1,1)
add.accessory(9,3,2,0,1)
add.accessory(10,2,2,0,1)
